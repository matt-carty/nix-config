{pkgs, ...}: {
  ...
  fonts.packages = with pkgs; [
    ...
    source-code-pro
    ttf_bitstream_vera
    (google-fonts.override {fonts = ["MochiyPopOne" "MPLUS1Code" "MouseMemoirs" "Lobster" "ZenKakuGothicNew" "NotoSans" "NotoSerifJP" "WorkSans" "Inter" "Archivo" "Prompt" "Modak" "MysteryQuest" "Ribeye"];})
