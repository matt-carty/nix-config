  ...
  users.users = {
    ...
    matt = {
      ...
      openssh.authorizedKeys.keys = [
        ...
        "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAINJZksvG0yddqDEdlML54czDTrm0YraoJcGC8pfd0ps6 matt@alien"
      ];
      ...
      extraGroups = ["wheel" "docker" "video" "render" "audio" "media" "backup" "www-data" "storage"];
    };
    backup = {
      ...
      extraGroups = ["wheel" "backup" "storage"];
    };
  };
}
