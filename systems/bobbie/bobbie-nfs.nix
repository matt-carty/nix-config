...
services.nfs.server.exports = ''
    ...
    /export/nextcloud	10.89.24.0/24(rw,fsid=1,no_subtree_check) 10.89.42.0/24(rw,no_subtree_check)
    /export/stuff 10.89.24.0/24(rw,fsid=2,no_subtree_check,all_squash,anonuid=1000) 10.89.42.0/24(rw,no_subtree_check,all_squash,anonuid=1000)
  '';
